...
HD_PWD='/media/psf/Home/vivado/aes7/aes7.runs/aes7_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes7_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes7_rst_ps7_0_50M_0.tcl
