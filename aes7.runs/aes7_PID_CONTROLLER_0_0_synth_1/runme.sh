...
HD_PWD='D:/school/AES/aes7-master/aes7.runs/aes7_PID_CONTROLLER_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes7_PID_CONTROLLER_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes7_PID_CONTROLLER_0_0.tcl
