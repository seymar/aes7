...
HD_PWD='/home/parallels/vivado/aes7/aes7.runs/aes7_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes7_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes7_processing_system7_0_0.tcl
