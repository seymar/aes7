...
HD_PWD='/media/psf/Home/vivado/aes7/aes7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes7_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes7_wrapper.tcl
