...
HD_PWD='/media/psf/Home/vivado/aes7/aes7.runs/aes7_blk_mem_gen_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes7_blk_mem_gen_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes7_blk_mem_gen_1_0.tcl
