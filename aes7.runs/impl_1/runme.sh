...
HD_PWD='D:/school/AES/aes7-master/aes7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aes7_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aes7_wrapper.tcl -notrace
