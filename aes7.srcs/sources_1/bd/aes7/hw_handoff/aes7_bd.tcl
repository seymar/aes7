...
# module references:
# PID_CONTROLLER, clk_dev, pscommunicator, pwm, quaddecoder
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_DOUT_DEFAULT {0x028507D0} \
  ...
  # Create instance: clk_dev_0, and set properties
  set block_name clk_dev
  set block_cell_name clk_dev_0
  if { [catch {set clk_dev_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $clk_dev_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {0.251953} \
   ...
   CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {0.2} \
  ...
  connect_bd_net -net RESET_0_1 [get_bd_ports btn0] [get_bd_pins PID_CONTROLLER_0/RESET] [get_bd_pins quaddecoder_0/reset]
  ...
  connect_bd_net -net clk_dev_0_clk_out [get_bd_pins PID_CONTROLLER_0/CLK] [get_bd_pins clk_dev_0/clk_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins clk_dev_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pscommunicator_0/clk] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net pscommunicator_0_D [get_bd_pins PID_CONTROLLER_0/KD_IN] [get_bd_pins pscommunicator_0/D]
  connect_bd_net -net pscommunicator_0_I [get_bd_pins PID_CONTROLLER_0/KI_IN] [get_bd_pins pscommunicator_0/I]
  connect_bd_net -net pscommunicator_0_P [get_bd_pins PID_CONTROLLER_0/KP_IN] [get_bd_pins pscommunicator_0/P]
