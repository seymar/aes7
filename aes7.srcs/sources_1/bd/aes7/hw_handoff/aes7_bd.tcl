...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net blk_mem_gen_1_doutb [get_bd_pins blk_mem_gen_1/doutb] [get_bd_pins setpointgenerator_0/bram_data]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins blk_mem_gen_1/clkb] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins setpointgenerator_0/clk]
